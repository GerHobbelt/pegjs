...
function generateJavascript(ast, options) {
  ...
  function generateMemoizationHeader(ruleIndexCode) {
    return arrays.merge([
  ...
  function generateMemoizationFooter(resultCode) {
    var stmts = [
      '',
  ...
  function generateInterpreter() {
    ...
    if (options.cache) {
      parts.push(indent2(generateMemoizationHeader('index')));
    }
    //{
    parts.push(arrays.merge([
      /*
    ...
    if (options.cache) {
      parts.push(indent2(generateMemoizationFooter('stack[0]')));
    }
  ...
  function generateRuleFunction(rule) {
    ...
    if (rule.memoize) {
      parts.push(indent2(
        generateMemoizationHeader(asts.indexOfRule(ast, rule.name))
      ));
    }
  ...
  parts.push(arrays.merge([
    ...
    '      }',
    '',
    '      if (peg$memoizedPos !== pos) {',
    '        if (peg$memoizedPos > pos) {',
    '          peg$memoizedPos = 0;',
    '          peg$memoizedPosDetails = { line: 1, column: 1, seenCR: false };',
    '        }',
    '        advance(peg$memoizedPosDetails, peg$memoizedPos, pos);',
    '        peg$memoizedPos = pos;',
    '      }',
    '',
    '      return peg$memoizedPosDetails;',
    '    }',
    '',
