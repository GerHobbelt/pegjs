...
module.exports = function(ast, options) {
  ...
  function phase1_visitPre(node, parent, context) {
  ...
  function phase1_visitRuleRef(node, parent, context) {
  ...
  function phase1_visitRuleDefinition(node, parent, context) {
  ...
  //    *probably* benefit fro memoization actually participate in the 
  //    packrat scheme.
  //
  ...
  function calcRuleVisitor(node, parent) {
    ...
    arrays.each(node.annotations, function(annotation) {
      patch(annotation, null, node, parent);
    });
