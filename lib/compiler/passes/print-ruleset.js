...
module.exports = function(ast, options) {
  ...
  function printPost(node, parent, returnValue, context) {
    //console.log("POST: type = ", node.type, ", name = ", node.name, ", depth = ", node.depth, ", parent = ", (node.parent ? node.parent.name : "---"), ", PARENT = ", (parent ? parent.name : "---"), ", context = ", context);
    return returnValue;
  }
  ...
  function printAnnotationPost(annotation, parent_annotation, node, parent, returnValue, context) { 
    //console.log("ANNO POST: type = ", annotation.type, ", name = ", annotation.name, ", parent_anno = ", parent_annotation, ", type = ", node.type, ", depth = ", node.depth, ", parent = ", (node.parent ? node.parent.name : "---"), ", PARENT = ", (parent ? parent.name : "---"), ", context = ", context);
    return returnValue;
  }
